...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Recommended</td>
            <td>The date and time when the log was created or updated (the logging api sets the format to ISO-8601).<br><strong>Note:</strong> Before Laravel 7, dates would be serialized to a format like the following: <strong>2019-12-02 20:01:00</strong>. From Laravel 7, dates serialized using the new format will appear like: <strong>2019-12-02T20:01:00.283041Z</strong>.</td>
        </tr>
        <tr>
            <td>logEmail</td>
            <td>boolean</td>
