...
Intelligent multi-coloured focus rings, for example instead of having a blue focus ring around a red danger button. To improve the appear of the ui in October II the focus ring would be a lighter red around a red danger button. Another example with an orange coloured warning button would have a light orange focus ring. This styling is rolled out throughtout the cms themes to match containers, buttons, links etc.
